...
refs.txt is a fork of the [todo.txt](https://github.com/todotxt/todo.txt) plain text format specification. Whereas [todo.txt](https://github.com/todotxt/todo.txt) is intended for specifying tasks and their priorities, refs.txt is intended for managing collections of academic literature. In other words, refs.txt is a plain text (and thus a minimalist) alternative to [Zotero](https://www.zotero.org/) or [Mendeley](https://www.mendeley.com/).
